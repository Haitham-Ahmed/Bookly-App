...
class VolumeInfo extends Equatable {
  ...
  factory VolumeInfo.fromNo(Map<String, dynamic> json) => VolumeInfo(
    ...
    industryIdentifiers:
        (json['industryIdentifiers'] as List<dynamic>?)
            ?.map((e) => IndustryIdentifier.fromNo(e as Map<String, dynamic>))
            .toList(),
    readingModes:
        json['readingModes'] == null
            ? null
            : ReadingModes.fromNo(json['readingModes'] as Map<String, dynamic>),
    ...
    imageLinks: ImageLinks.fromNo(json['imageLinks'] as Map<String, dynamic>),
  ...
  Map<String, dynamic> toNo() => {
    ...
    'industryIdentifiers': industryIdentifiers?.map((e) => e.toNo()).toList(),
    'readingModes': readingModes?.toNo(),
    'pageCount': pageCount,
    'printType': printType,
